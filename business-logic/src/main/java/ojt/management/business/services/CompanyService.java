...
public interface CompanyService {
    ...
    Company updateCompany(CompanyUpdateRequest companyUpdateRequest, Long accountId) throws CrudException;

    Company getCompanyById(Long id, Long accountId) throws CrudException;

    Company createCompany(CompanyCreateRequest companyCreateRequest, Long accountId) throws CrudException;
