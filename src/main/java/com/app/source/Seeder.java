...
public class Seeder {
    ...
    private void seedAccount() {
        List<SignupRequest> signupRequests = Arrays.asList(
                ...
                new SignupRequest("student1@gmailcom", "123456", "Sutdent", "STUDENT", "0988988796", "123 Street, Ward 11, A District, ABC city", "SE150099", Long.valueOf(1)),
                new SignupRequest("student2@gmailcom", "123456", "Sutdent", "STUDENT", "0988988796", "124 Street, Ward 11, A District, ABC city", "SE150098", Long.valueOf(1)),
                new SignupRequest("studentd3@gmailcom", "123456", "Sutdent", "STUDENT", "0988988796", "125 Street, Ward 11, A District, ABC city", "BA150097", Long.valueOf(2)),
